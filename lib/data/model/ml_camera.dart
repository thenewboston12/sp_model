...
import 'package:flutter_japan_v2/data/model/classifier.dart';
import 'package:flutter_japan_v2/utils/image_utils.dart';
import 'package:flutter_japan_v2/data/entity/recognition.dart';
...
class MLCamera {
  MLCamera(this._read, this.cameraController, this.cameraViewSize) {
    Future(() async {
